package com.futurecity.game.lwjgl3;
...
/**
 * Lá»›p khá»Ÿi cháº¡y á»©ng dá»¥ng trĂªn mĂ¡y tĂ­nh sá»­ dá»¥ng thÆ° viá»‡n LWJGL3.
 * Chá»‹u trĂ¡ch nhiá»‡m cáº¥u hĂ¬nh cá»­a sá»•, FPS, Ä‘á»“ há»a vĂ  biá»ƒu tÆ°á»£ng á»©ng dá»¥ng.
 */
public class Lwjgl3Launcher {
    public static void main(String[] args) {
        Thread.setDefaultUncaughtExceptionHandler((thread, throwable) -> {
            System.err.println("[CRASH CRITICAL FATAL] Uncaught Exception on thread: " + thread.getName());
            throwable.printStackTrace();
            // Log to file if needed or show error dialog
        });
    ...
    /**
     * Cáº¥u hĂ¬nh máº·c Ä‘á»‹nh cho cá»­a sá»• trĂ² chÆ¡i (TĂªn, Vsync, FPS...).
     */
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        Lwjgl3ApplicationConfiguration configuration = new Lwjgl3ApplicationConfiguration();
        configuration.setTitle("FutureCity");
