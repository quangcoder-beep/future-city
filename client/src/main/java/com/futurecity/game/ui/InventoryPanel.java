...
/**
 * TÄ‚Âºi Ă„â€˜Ă¡Â»â€œ cĂ¡Â»Â§a ngĂ†Â°Ă¡Â»Âi chĂ†Â¡i: hiĂ¡Â»â€¡n Coins, Items, Ă„â€˜Ă†Â¡n Ă„â€˜ang giao.
 * MĂ¡Â»Å¸ bĂ¡ÂºÂ±ng bĂ¡ÂºÂ¥m H.
 * Player's inventory: shows Coins, Items, active deliveries. Open by pressing H.
 */
